...
const userData = {
    ...
    hard_skills: [
        ...
        {name: "HTML/CSS", level: 5, description: "Conhecimento básico para front-end"},
        {name: "Amazon QuickSight", level: 4, description: "Ferramenta de BI do banco"},
        {name: "Figma", level: 4, description: "Ferramenta de design de interfaces"},
        ...
        {name: "Terraform", level: 4, description: "Infraestrutura como código"},
        {name: "JavaScript", level: 4, description: "Programação para web"},
        {name: "AWS Step Functions", level: 3, description: "Orquestração de workflows"},
        {name: "Angular", level: 3, description: "Framework front-end para aplicações web"},
        {name: "Kubernetes", level: 3, description: "Gerenciamento de containers"},
        {name: "Docker", level: 3, description: "Containerização de aplicações"},
        {name: "Kafka/Mensageria", level: 3, description: "Streaming de dados em tempo real"},
    ],
    soft_skills: [
        {name: "Pensamento Crítico", level: 5, description: "Análise e resolução de problemas"},
        ...
        {name: "Colaboração", level: 3, description: "Trabalho em equipe eficaz"},
        ...
        {name: "Comunicação Não-Violenta", level: 2, description: "Técnicas de comunicação respeitosa"},
    ],
    milestones: [
        {
            id: 1,
