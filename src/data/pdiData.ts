...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    progress: 100,
    deadline: '2025-06-30',
    notes: 'Participei de workshops de CNV e storytelling, melhorando significativamente minha comunicação.',
  ...
  },
  {
    ...
    progress: 100,
    deadline: '2025-09-30',
    notes: 'Liderei com sucesso o projeto Agente Leila, reduzindo 80% do tempo de análise.',
  ...
  },
  {
    ...
    displayName: 'AWS Solutions Architect Professional',
    description: 'Avançar em certificações AWS para nível Professional',
    status: 'in-progress',
    progress: 40,
    deadline: '2026-06-30',
  ...
  },
  {
    ...
    progress: 100,
    deadline: '2025-12-31',
    notes: 'Mentorei 3 engenheiros júnior, compartilhando conhecimento e acelerando seu desenvolvimento.',
  ...
  },
  {
    ...
    progress: 100,
    deadline: '2025-11-30',
    notes: 'Reduzi 30% dos custos de infraestrutura através de otimizações e boas práticas.',
...
export const resources: Resource[] = [
  ...
  {
    id: 'cert-analytics',
    name: 'AWS Certified Analytics - Specialty',
    description: 'Certificação profissional em Analytics na plataforma AWS - Especialização em Engenharia de Analytics',
    status: 'completed',
