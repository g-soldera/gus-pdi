                    ...
                    >
                      ...
                      <div className="absolute left-8 top-6 w-6 h-6 -translate-x-1/2">
                       ...
                       <motion.button
                        ...
                        whileTap={{ scale: 0.99 }}
                        className={`w-full bg-card border border-border rounded-xl p-6 shadow-sm hover:shadow-md hover:border-primary transition-all text-left group ${milestone.archived ? 'opacity-60 bg-gray-50' : ''}`}
                      >
                        <div className="flex flex-wrap items-start justify-between gap-4 mb-4">
                          <div className="flex-1">
                            <h3 className="text-xl mb-2 group-hover:text-primary transition-colors font-bold">
                              {milestone.title} {milestone.archived && <Archive className="inline w-4 h-4 ml-2 text-muted-foreground" />}
                            </h3>
              ...
              {sortedMilestones.map((milestone, index) => {
                ...
                return (
                   <motion.button
                     ...
                     onClick={() => onMilestoneClick(milestone)}
                     whileHover={{ y: -8 }}
                     className={`bg-card border border-border rounded-xl p-6 shadow-sm hover:shadow-md hover:border-primary transition-all text-left group flex flex-col h-full ${milestone.archived ? 'opacity-60 bg-gray-50' : ''}`}
                   >
